...
import { Eye, EyeOff, Sparkles, ArrowRight, Loader, Mail, Lock } from 'lucide-react'
      ...
      <div className="auth-form-panel">
        <div className="premium-auth-card">
          ...
          <div className="social-login-grid">
            <button type="button" className="btn-social" onClick={() => toast.success('Google Login simulated')}>
            ...
            <button type="button" className="btn-social" onClick={() => toast.success('GitHub Login simulated')}>
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
          ...
          <div className="auth-separator">or sign in with email</div>
